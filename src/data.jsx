...
const DATA = {
  ...
  reports: {
    ...
    withoutRefresh: 12,
    items: [
      { name: 'Margin Dashboard',         ws: 'Finance-Prod',   type: 'Power BI',   dataset: 'Sales Analytics',          wsId: 'finance-prod',   modelId: 'sales-analytics',  viewers30: 142, opens30: 1842, modified: '2d ago',   status: 'healthy', refresh: 'ok',     visuals: 12, tone: 'sky' },
      { name: 'Pipeline 360',             ws: 'Sales',          type: 'Power BI',   dataset: 'Sales Analytics',          wsId: 'finance-prod',   modelId: 'sales-analytics',  viewers30: 84,  opens30: 612,  modified: '5d ago',   status: 'healthy', refresh: 'ok',     visuals: 14, tone: 'amber' },
      { name: 'YTD Variance Report',      ws: 'Finance-Prod',   type: 'Paginated',  dataset: 'Budget Planning',          wsId: 'finance-prod',   modelId: 'budget-planning',  viewers30: 38,  opens30: 287,  modified: '1w ago',   status: 'healthy', refresh: 'ok',     visuals: 4,  tone: 'sky' },
      { name: 'Q4 Sales Snapshot 2024',   ws: 'Sales',          type: 'Power BI',   dataset: 'Legacy Sales',             wsId: null,             modelId: null,               viewers30: 0,   opens30: 0,    modified: '94d ago',  status: 'orphan',  refresh: 'failed', visuals: 18, tone: 'amber' },
      { name: 'EMEA Quarterly Review',    ws: 'Finance-Prod',   type: 'Power BI',   dataset: 'Revenue Forecast',         wsId: 'finance-prod',   modelId: 'sales-analytics',  viewers30: 22,  opens30: 124,  modified: '3w ago',   status: 'healthy', refresh: 'ok',     visuals: 9,  tone: 'sky' },
      { name: 'Plant Output Live',        ws: 'Operations',     type: 'Power BI',   dataset: 'Plant Output (PILOT)',     wsId: null,             modelId: null,               viewers30: 4,   opens30: 18,   modified: '47d ago',  status: 'dormant', refresh: 'stale',  visuals: 7,  tone: 'emerald' },
      { name: 'Marketing Funnel 2024',    ws: 'Marketing',      type: 'Power BI',   dataset: 'Marketing Funnel 2024',    wsId: null,             modelId: null,               viewers30: 0,   opens30: 0,    modified: '94d ago',  status: 'orphan',  refresh: 'stale',  visuals: 11, tone: 'violet' },
      { name: 'HR Attrition',             ws: 'HR-Data',        type: 'Power BI',   dataset: 'HR Headcount',             wsId: null,             modelId: null,               viewers30: 17,  opens30: 84,   modified: '12d ago',  status: 'healthy', refresh: 'ok',     visuals: 6,  tone: 'rose' },
      { name: 'Operations Scorecard',     ws: 'Ops-Score',      type: 'Power BI',   dataset: 'Ops Scorecard',            wsId: null,             modelId: null,               viewers30: 64,  opens30: 412,  modified: '4d ago',   status: 'healthy', refresh: 'ok',     visuals: 8,  tone: 'emerald' },
      { name: 'Stockout Alert Status',    ws: 'Operations',     type: 'Power BI',   dataset: '(deleted)',                wsId: null,             modelId: null,               viewers30: 0,   opens30: 0,    modified: '187d ago', status: 'broken',  refresh: 'na',     visuals: 3,  tone: 'rose' },
    ],
  },
